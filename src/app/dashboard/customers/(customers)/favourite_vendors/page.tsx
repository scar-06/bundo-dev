        ...
        <div className="flex w-full flex-col items-center lg:my-6 ">
          <div className="w-full">
            <div className="flex w-full  flex-col items-center">
              ...
              <div
                // tabIndex={0}
                className="group my-3 flex h-[53px] w-full items-center gap-2 rounded-[5px] border border-[#c8c8c8] bg-[rgba(222,_242,_251,_0.30)] px-[10px]  lg:w-[511px]"
              >
                <span className="">
          ...
          {tabkey === "0" ? (
            isFetching ? (
              ...
              <>
                <div className=" mt-4 grid w-full grid-cols-2 gap-4  md:grid-cols-3 lg:grid-cols-4">
            ...
            <>
              <div className=" mt-4 grid w-fit   gap-6 md:grid-cols-2 lg:grid-cols-4">
