...
function RecommendeVendors() {
  ...
  return (
    <div className="w-full mmd:-mt-5 ">
      <div className="flex items-center gap-2 pb-4 ">
        <GoBack text="Recommended vendors" />
      ...
      <div className="flex w-full flex-col items-center lg:my-6 ">
        <div className="flex w-full flex-col items-center">
          <div className="group my-3 flex h-[53px] w-full items-center gap-2 rounded-[5px] border border-[#c8c8c8] bg-[rgba(222,_242,_251,_0.30)] px-[10px]  sm:w-[557px]">
            <span className="">
                  ...
                  {productVendors?.map((element) => (
                    <VendorCard
                      ...
                      business_profile_picture={
                        element?.business_profile_picture
                      }
